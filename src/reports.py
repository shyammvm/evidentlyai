...
class Reports:
    ...
    def target_drift_report_generator(self):
    ...
    def data_drift_report_generator(self):
    ...
    def data_quality_report_generator(self):
    ...
    def get_report(self):
        ...
        if self.db_check() and self.type in report_generators:
